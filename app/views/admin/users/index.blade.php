                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('هل انت متاكد من الحذف ؟');" href="{{URL::to('users/delete/' . $uu->id)}}" class="btn default btn-xs black">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{URL::route('deleteuser' , $uu->id)}}" class="btn blue">تاكيد  </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="rtl" lang="ar">
    ...
    <head>
        ...
        <meta name="description" content="{{$main->site_desc }}">
            <meta name="keywords" content="{{$main->site_comment }}">

                <title>
                    <?php
                    if (!empty($main->site_title)) {
                        echo $main->site_title;
                    } else {
                        Get_Site_Title();
                    }
                    ?>
                    ...
                    <div class="wrapper">
                        <header>
                            ...
                            <ul class="menu">
                                ...
                                <li>{{ HTML::image($cc->image , null  , array('height'=>'11' , 'width'=>'25'))}} <a href="{{URL::to('site/cat/'.$cc->id)}}">{{$cc->section_name}} </a></li>
                                @endforeach
                                @else
                        ...
                        <div class="search-section" style=" float: left; margin-left:-300; margin-bottom: 10px; ">
                            <form action="{{URL::to('site/searchads')}}" method="GET">
                                <input type="text" name="key" placeholder="أدخل كلمة البحث" />
                                {{ Form::select('city' , $cit )}}

                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="{{URL::route('showreportsads' , $uu->id)}}" class="btn default btn-xs purple">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{URL::route('deletereportsads' , $uu->id)}}" class="btn blue">تاكيد  </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

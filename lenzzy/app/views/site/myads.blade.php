    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p04">
        ...
        <table class="table tableAds table-borderedAds ">
            ...
            <tr style="background-color:#F8FAC1">
                ...
                <td>
                    <a href="{{URL::to('site/editmyads/'. $a2->id)}}">	تعديل </a>
                    | 

                    <a onclick="return confirm('هل انت متأكد من الحذف ؟');" href="{{URL::to('site/deletemyads/'. $a2->id)}}">حذف </a>
